 ...
 *
 * @property \Cake\ORM\Table&\Cake\ORM\Association\HasMany $Statistic
 ...
 * @method \App\Model\Entity\StatCategory|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\StatCategory saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\StatCategory[]|\Cake\Datasource\ResultSetInterface|false saveMany($entities, $options = [])
 */
