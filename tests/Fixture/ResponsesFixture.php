...
class ResponsesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'response' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        'alignment' => ['type' => 'integer', 'length' => 4, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'recreation_rank' => 1,
            'alignment' => 1,
            'response_date' => '2015-07-15 20:00:02',
            'created' => '2015-07-15 20:00:02',
            'modified' => '2015-07-15 20:00:02'
        ],
    ];
}
