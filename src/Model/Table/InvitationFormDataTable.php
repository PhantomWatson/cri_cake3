 ...
 * @method \App\Model\Entity\InvitationFormData|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\InvitationFormData saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\InvitationFormData[]|\Cake\Datasource\ResultSetInterface|false saveMany($entities, $options = [])
 */
